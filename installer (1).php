...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Car_rental_10615e06fac912fc8808_20220923040035_archive.zip';
        const ARCHIVE_SIZE       = '53013520';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '10615e0-23040035';
        const SECONDARY_PACKAGE_HASH = 'a7a9a97-23040035';
        const VERSION            = '1.5.0';
